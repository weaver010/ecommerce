                                    ...
                                    <td style="padding-top: 30px;">
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                        Phone: 111-222-3333 | Email: info@sitemakers.in
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                                        <strong>Order Number:</strong> {{$orderDetails['_id']}} | <strong>Order Date:</strong> {{ date("F j, Y, g:i a", strtotime($orderDetails['created_at'])); }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 8px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                                        <?php echo DNS1D::getBarcodeHTML($orderDetails['_id'], 'C93'); ?>
                                                    </td>
                                                </tr>
                                        ...
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 130px;"><?php echo DNS1D::getBarcodeHTML($order['product_code'], 'C93'); ?></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #bbbbbb; margin-top: -5px;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; font-weight: bold; line-height: 18px; color: #666666; padding-top: 10px; text-align: right;">@if($orderDetails['coupon_amount']>0)
