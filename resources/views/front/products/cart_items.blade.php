                            ...
                            <tbody>
                                ...
                                @foreach($getCartItems as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <span class="table-p__price">₹{{$item['product']['final_price']}}
                                            </span> -->
                                            <div class="pd-detail__inline">
                                                <span class="pd-detail__price" style="font-size: 16px;">₹{{$getAttributePrice['final_price']}}</span>
                                                @if($getAttributePrice['discount']>0)
                                                    <span class="pd-detail__discount">({{$getAttributePrice['discount_percent']}}% OFF)</span><del class="pd-detail__del">₹{{$getAttributePrice['product_price']}}</del>
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <!--====== Input Counter ======-->
                                              <div class="input-counter">
                                               <span class="input-counter__minus fas fa-minus updateCartItem qtyMinus" data-cartid="{{ $item['_id'] }}" data-qty={{ $item['product_qty'] }}></span>
                                                ...
                                                <span class="input-counter__plus fas fa-plus updateCartItem qtyPlus" data-cartid="{{ $item['_id'] }}" data-qty={{ $item['product_qty'] }}></span></div>
                                              <!--====== End - Input Counter ======-->
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-p__del-wrap">
                                                <a class="far fa-trash-alt table-p__delete-link deleteCartItem" data-page="Cart" href="#" data-cartid="{{$item['_id']}}"></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <!--====== End - Row ======-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 u-s-m-b-30">
                    <form class="f-cart" method="post" action="javascript:void(0);">@csrf
                        <div class="f-cart__pad-box">
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input class="input-text input-text--primary-style" type="text" name="code" id="code" placeholder="Enter Coupon Code"></div>
                            <div class="u-s-m-b-30">
                                <button id="ApplyCoupon" @if(Auth::check()) user="1" @endif class="f-cart__ship-link btn--e-transparent-brand-b-2" type="submit" style="width:100%;">APPLY</button>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 u-s-m-b-30">
                    <div class="f-cart__pad-box">
                        ...
                        <div>
                            <a href="{{ url('checkout') }}"><button style="cursor: pointer;" class="f-cart__ship-link btn--e-transparent-brand-b-2" type="submit"> PROCEED TO CHECKOUT</button></div></a>
