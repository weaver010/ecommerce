                    ...
                    <div class="pd-detail">
                        ...
                        <div>
                            <div class="pd-detail__inline getAttributePrice">
                                ...
                                @if($productDetails['discount_type']!="")
                                    <span class="pd-detail__discount">(10% OFF)</span><del class="pd-detail__del">₹{{$productDetails['product_price']}}</del>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="u-s-m-b-15">
                              <div class="pd-detail__inline">
                                     @if($total_stock>5)
                                            <span class="pd-detail__stock">{{$total_stock}} in stock</span>
                                     @elseif($total_stock>0 && $total_stock<=5)
                                             <span class="pd-detail__left">Only {{$total_stock}} Left</span>
                                     @else
                                              <span class="pd-detail__left">No Stock Left</span>    
                                     @endif
                                </div>
                        </div>
                        <div class="u-s-m-b-15">
                        ...
                        <div class="u-s-m-b-15">
                            <form name="addToCart" id="addToCart" class="pd-detail__form" action="javascript:;">
                                <input type="hidden" name="product_id" value="{{ $productDetails['_id'] }}">
                                            ...
                                            @foreach($groupProducts as $product)    
                                                <a href="{{ url('product/'.$product['_id']) }}">
                                                    <div class="color__radio">
                                                        <label class="color__radio-label" for="folly" style="background-color: {{$product['family_color']}}">
                                                        </label>
                                                    </div>
                                                </a>
                                            @endforeach
                                ...
                                <div class="u-s-m-b-15">
                                       <span class="pd-detail__label u-s-m-b-8">Size:</span>
                                            <div class="pd-detail__size">
                                               @foreach($productDetails['attributes_front'] as $attribute)
                                                    <div class="size__radio">
                                                        <input type="radio" id="{{ $attribute['size'] }}" name="size" product-id="{{ $productDetails['_id'] }}" value="{{ $attribute['size'] }}" class="getPrice" required>
                                                        <label class="size__radio-label">{{ $attribute['size'] }}</label>
                                                    </div>
                                               @endforeach                               
                                        </div>
                                </div>
                            ...
                            <!--====== Tab 2 ======-->
                             <div class="tab-pane" id="pd-tag">
                                <div class="pd-tab__tag">
                                    ...
                                    <div class="u-s-m-b-15">
                                        @if(isset($productDetails['product_video']))
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section__text-wrap">
                            <h1 class="section__heading u-c-secondary u-s-m-b-12">RELATED PRODUCTS YOU MAY LIKE</h1>

                            <span class="section__span u-c-grey">PRODUCTS WITH SAME CATEGORY</span>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="u-s-m-b-30">
                        <div class="product-o product-o--hover-on">
                            <div class="product-o__wrap">
                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="{{ url('product/'.$product['_id']) }}">
                            ...
                            <span class="product-o__name">
                                ...
                                <a href="{{ url('product/'.$product['_id']) }}">{{ $product['product_name'] }}</a></span>
